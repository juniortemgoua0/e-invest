...
export function SemiCircularProgressbar({children, debit, actif, progression, status, onSetActif}: Props) {
  ...
  useEffect(() => {
    ...
    if (status === 0) {
      ...
      let progressTime: number = (debit as number) * 36 / 1.5
