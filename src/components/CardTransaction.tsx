      ...
      <div className="d-flex justify-content-between">
        <div className="d-flex align-items-center">
          <div className="rounded-circle d-flex justify-content-center align-items-center"
               style={{width: "70px", height: "70px", backgroundColor: "var(--bg-primary-color)"}}>
          ...
          <div className="d-flex flex-column justify-content-evenly ms-3" style={{width: "120px"}}>
            <span className="fs-5">{type === TYPE ? "Mise" : "Retrait"}</span>
        ...
        <div className="d-flex flex-column justify-content-between" style={{width: "120px"}}>
              <span className="text-end">
                <span style={{fontSize: "23px"}} className="me-2 ">{amount}</span>
